(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["svelte-keydown"] = factory());
    ...
    /* src/Keydown.svelte generated by Svelte v3.55.1 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			if (!mounted) {
    				dispose = [
    					listen(document.body, "keyup", /*keyup_handler*/ ctx[8]),
    					listen(document.body, "keyup", /*keyup_handler_1*/ ctx[10]),
    					listen(document.body, "keydown", /*keydown_handler*/ ctx[9]),
    					listen(document.body, "keydown", /*keydown_handler_1*/ ctx[11])
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('separator' in $$props) $$invalidate(7, separator = $$props.separator);
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*combo, separator*/ 132) {
    			$$invalidate(3, combination = combo.join(separator));
    		}
    ...
    class Keydown extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, { paused: 0, pauseOnInput: 1, separator: 7 });
    	}
    }
